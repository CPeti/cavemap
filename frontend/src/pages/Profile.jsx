                            ...
                            <div className="space-y-4">
                                ...
                                {profile?.bio && (
                                    <div>
                                        ...
                                        <div className="text-sm text-slate-300 bg-slate-900/50 border border-slate-700/50 rounded-lg px-3 py-2">
                                            {profile.bio}
                                        </div>
                                    </div>
                                )}
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6">
                            ...
                            <div className="space-y-3">
                                <button className="w-full flex items-center justify-between p-3 bg-slate-700/50 hover:bg-slate-700 rounded-lg transition-colors text-left">
                                ...
                                >
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div className="text-xs text-slate-500">Update profile info</div>
                                        </div>
                                    </div>
                                    <div className="text-slate-500">→</div>
                                </button>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="flex gap-3 pt-2">
                                <button
                                    ...
                                    className="flex-1 bg-teal-500 text-white font-medium px-4 py-2 rounded-lg hover:bg-teal-400 transition-colors"
                                >
                                    Save Changes
                                </button>
                                <button
