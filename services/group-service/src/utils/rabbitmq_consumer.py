...
class RabbitMQConsumer:
    ...
    def _register_handlers(self):
        ...
        # Example of how to add new handlers:
        # self.message_handlers['user.created'] = UserCreationMessageHandler()
        # self.message_handlers['group.updated'] = GroupUpdateMessageHandler()
    ...
    def _log_event(self, event_data: Dict[str, Any]) -> None:
        ...
        # Log common fields
        for field in ['event', 'userId', 'email', 'username', 'deletedAt', 'timestamp']:
